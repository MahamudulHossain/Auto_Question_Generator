<?php include('top.php');?>
                ...
                <div class="x_content">
                  <br>
                  <form action="MultiQuestionPDF.php" method="POST">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6">
                          <label class="col-form-label col-md-3 col-sm-3 label-align">Chapters<span class="required">*</span>
                          </label>
                          <div class="col-md-9 col-sm-9" id="chap_ids">
                    ...
                    <div class="item form-group">
                     ...
                     <div class="text-right">
                      <button class="btn btn-lg multi_chap_btn" name="generate">Generate</button>
                    </div>
                  </form> 
                </div>
